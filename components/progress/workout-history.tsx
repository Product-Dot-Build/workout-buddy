        ...
        {logs.map((log, i) => {
          ...
          return (
            <button
              ...
              className="forge-card flex w-full items-center gap-3 rounded-xl border border-border bg-card p-3 text-left transition-colors hover:border-primary/30 hover:bg-card/80 active:bg-card/60"
